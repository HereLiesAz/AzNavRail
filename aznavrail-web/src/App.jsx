...
function App() {
  ...
  const [relocItems, setRelocItems] = useState([
      { id: 'reloc1', text: 'R1', route: 'R1', isRailItem: true, isRelocItem: true, hostId: 'home', hiddenMenu: [{ text: 'Hidden 1', onClick: () => alert('Hidden 1') }] },
      { id: 'reloc2', text: 'R2', route: 'R2', isRailItem: true, isRelocItem: true, hostId: 'home' },
      { id: 'reloc3', text: 'R3', route: 'R3', isRailItem: true, isRelocItem: true, hostId: 'home' }
  ]);
  ...
  const navItems = [
    ...
    ...relocItems,
    {
      ...
      items: [
          { id: 'buttons', text: 'Buttons', route: 'Buttons', info: 'View Button demos', onClick: () => setCurrentPage('Buttons') },
          { id: 'inputs', text: 'Inputs', route: 'Inputs', info: 'View Input demos', onClick: () => setCurrentPage('Inputs') },
          { id: 'forms', text: 'Forms', route: 'Forms', info: 'View Form demos', onClick: () => setCurrentPage('Forms') },
      ]
    },
    {
        id: 'settings',
