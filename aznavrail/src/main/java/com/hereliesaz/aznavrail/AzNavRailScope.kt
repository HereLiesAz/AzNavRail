...
interface AzNavRailScope {
    ...
    fun azRailRelocItem(id: String, hostId: String, text: String, color: Color? = null, shape: AzButtonShape? = null, disabled: Boolean = false, screenTitle: String? = null, info: String? = null, hiddenMenu: HiddenMenuScope.() -> Unit = {})
}
...
internal class AzNavRailScopeImpl : AzNavRailScope {
    ...
    override fun azRailRelocItem(id: String, hostId: String, text: String, color: Color?, shape: AzButtonShape?, disabled: Boolean, screenTitle: String?, info: String?, hiddenMenu: HiddenMenuScope.() -> Unit) {
        val hiddenMenuScope = HiddenMenuScopeImpl()
        hiddenMenuScope.hiddenMenu()
        hiddenMenuOnClickMap.putAll(hiddenMenuScope.onClickMap)
