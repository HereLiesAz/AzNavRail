 ...
 *  - [TERTIARY] — *a second app-driven highlight*, ranked below secondary. Same mechanism, lower
 *    precedence: focus > active > secondary > tertiary. Turn it on with
 *    `azItemState(id, tertiary = true)` or `azConfig(tertiaryClassifiers = …)`.
 *
