...
/** Compose convenience for [AzNavMode.isGestureNav], scoped to the current context. */
@Composable
internal fun rememberIsGestureNav(): Boolean {
    val context = LocalContext.current
    return remember(context) { AzNavMode.isGestureNav(context) }
}
