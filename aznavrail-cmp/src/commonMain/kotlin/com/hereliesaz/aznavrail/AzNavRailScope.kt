...
import com.hereliesaz.aznavrail.model.AzItemHighlight
...
interface AzNavRailScope {
     ...
     * @param activeClassifiers A set of strings used to highlight items programmatically — any item
     *   declaring a matching classifier wears the **active** highlight.
     * @param secondaryClassifiers The same mechanism for the **secondary** highlight: any item
     *   declaring a matching classifier wears it. The declarative counterpart to
     *   `azItemState(id, secondary = true)`.
     ...
     * @param railItemWidth Uniform size for every rail item button. [Dp.Unspecified] uses the
     *   built-in default; set it to size all rail items to a value you define.
     ...
     *
     * @param activeColor The colour of the **active** highlight: the item whose route is the current
     *   destination, or whose classifier is listed in `azConfig(activeClassifiers = …)`.
     * @param focusColor The colour of the **focus** highlight: the item under the finger, and the
     *   last-tapped item when it carries no route of its own. [Color.Unspecified] (the default)
     *   reuses [activeColor], which is how the rail has always looked — set it only when you want
     *   "where you are" and "what you are touching" to read differently.
     * @param secondaryColor The colour of the **secondary** highlight — the third one, which the
     *   library never lights on its own. It is yours: turn it on per item with
     *   `azItemState(id, secondary = true)`, or declaratively with
     *   `azConfig(secondaryClassifiers = …)`, for state only the app knows (syncing, armed, locked).
     *   Override any of the three on a single item with [azHighlight].
     ...
     * @param dedupeAbout Whether the library de-duplicates the About affordance across every surface
     *   that could offer one. True by default: with a drop-down menu on screen as well as the rail,
     *   About would otherwise appear in both footers *and* on the `?` button. The most deliberate
     *   placement wins — your own [azAboutRailItem], then the rail's menu footer, then a drop-down's
     *   footer, then the automatic `?`.
     */
    fun azAbout(inAppAbout: Boolean = true, moreFromAzEnabled: Boolean = true, moreFromAzJsonUrl: String = "https://raw.githubusercontent.com/HereLiesAz/AzNavRail/main/more-from-az.json", moreRailItem: Boolean = false, aboutRailItem: Boolean = true, dedupeAbout: Boolean = true)
     ...
     */
    fun azAboutRailItem(id: String = "about", text: String = "?", content: Any? = null, color: Color? = null, shape: AzButtonShape? = null, menuText: String? = null, textColor: Color? = null, fillColor: Color? = null, translucentBackgroundColor: Color? = null, info: String? = null, badge: String? = null, persistentBadge: Boolean = false, isLoading: Boolean = false)
     ...
     */
    fun azHelpRailItem(id: String, text: String = "Help", content: Any? = null, color: Color? = null, shape: AzButtonShape? = null, menuText: String? = null, textColor: Color? = null, fillColor: Color? = null, translucentBackgroundColor: Color? = null, badge: String? = null, persistentBadge: Boolean = false, isLoading: Boolean = false)
     ...
     * @param shape Custom shape.
     */
    fun azHelpSubItem(id: String, hostId: String, text: String = "Help", content: Any? = null, color: Color? = null, shape: AzButtonShape? = null, menuText: String? = null, textColor: Color? = null, fillColor: Color? = null, translucentBackgroundColor: Color? = null, badge: String? = null, persistentBadge: Boolean = false, isLoading: Boolean = false)
     ...
     * @param onClick Callback invoked when the item is clicked.
     * @param hiddenMenu Scope to define context menu actions revealed by long-pressing this item.
     ...
     */
    fun azRailItem(id: String, text: String = "", route: String? = null, content: Any? = null, color: Color? = null, shape: AzButtonShape? = null, disabled: Boolean = false, screenTitle: String? = null, info: String? = null, classifiers: Set<String> = emptySet(), menuText: String? = null, textColor: Color? = null, fillColor: Color? = null, translucentBackgroundColor: Color? = null, badge: String? = null, persistentBadge: Boolean = false, isLoading: Boolean = false, onFocus: (() -> Unit)? = null, forceHiddenMenuOpen: Boolean = false, onHiddenMenuDismiss: (() -> Unit)? = null, hiddenMenu: HiddenMenuScope.() -> Unit = {}, onClick: (() -> Unit)? = null)
     ...
     * @param reflectSelectionInParent When true, the host button's displayed text/content is derived
     *   from the currently selected (non-host) child instead of this item's own declared text/
     *   content, a plain tap fires that child's action directly instead of opening the popup, and a
     *   long-press opens the popup (the plain-tap behavior when this is false, the default). Tapping
     *   a child inside the open popup updates the selection. Fully backward compatible: false (the
     *   default) is pixel-for-pixel identical to today.
     * @param selectedChildId Optional initial selection, seeded once on first appearance (like
     *   `initiallyExpanded`) — a later DSL change to this value does not override the user's own
     *   subsequent taps. Only meaningful when [reflectSelectionInParent] is true.
     * @param expandWhen Optional reactive condition for the popup's own open/closed state — same
     *   rising/falling-edge, "user wins" semantics as a host item's `expandWhen`. A false→true
     *   transition opens the popup; a true→false transition closes it (unless the user already
     *   closed it manually while the condition stayed true, mirroring host `expandWhen`).
     * @param nestedContent DSL block to define the items within the nested rail.
     */
    fun azNestedRail(id: String, text: String = "", route: String? = null, content: Any? = null, color: Color? = null, shape: AzButtonShape? = null, alignment: AzNestedRailAlignment = AzNestedRailAlignment.VERTICAL, disabled: Boolean = false, screenTitle: String? = null, info: String? = null, classifiers: Set<String> = emptySet(), menuText: String? = null, textColor: Color? = null, fillColor: Color? = null, translucentBackgroundColor: Color? = null, badge: String? = null, persistentBadge: Boolean = false, isLoading: Boolean = false, onFocus: (() -> Unit)? = null, keepNestedRailOpen: Boolean = false, reflectSelectionInParent: Boolean = false, selectedChildId: String? = null, expandWhen: (() -> Boolean)? = null, forceHiddenMenuOpen: Boolean = false, onHiddenMenuDismiss: (() -> Unit)? = null, hiddenMenu: HiddenMenuScope.() -> Unit = {}, nestedContent: AzNavRailScope.() -> Unit)
     ...
     */
    fun azMenuToggle(id: String, isChecked: Boolean, toggleOnText: String, toggleOffText: String, route: String? = null, color: Color? = null, shape: AzButtonShape? = null, disabled: Boolean = false, screenTitle: String? = null, info: String? = null, classifiers: Set<String> = emptySet(), menuToggleOnText: String? = null, menuToggleOffText: String? = null, textColor: Color? = null, fillColor: Color? = null, translucentBackgroundColor: Color? = null, badge: String? = null, persistentBadge: Boolean = false, isLoading: Boolean = false, onClick: (() -> Unit)? = null)
     ...
     */
    fun azRailToggle(id: String, isChecked: Boolean, toggleOnText: String, toggleOffText: String, route: String? = null, color: Color? = null, shape: AzButtonShape? = null, disabled: Boolean = false, screenTitle: String? = null, info: String? = null, classifiers: Set<String> = emptySet(), menuToggleOnText: String? = null, menuToggleOffText: String? = null, textColor: Color? = null, fillColor: Color? = null, translucentBackgroundColor: Color? = null, badge: String? = null, persistentBadge: Boolean = false, isLoading: Boolean = false, forceHiddenMenuOpen: Boolean = false, onHiddenMenuDismiss: (() -> Unit)? = null, hiddenMenu: HiddenMenuScope.() -> Unit = {}, onClick: (() -> Unit)? = null)
    ...
    fun azRailSlider(
        ...
        fillColor: Color? = null, translucentBackgroundColor: Color? = null,
     ...
     */
    fun azMenuCycler(id: String, options: List<String>, selectedOption: String, route: String? = null, color: Color? = null, shape: AzButtonShape? = null, disabled: Boolean = false, disabledOptions: List<String>? = null, screenTitle: String? = null, info: String? = null, classifiers: Set<String> = emptySet(), menuOptions: List<String>? = null, textColor: Color? = null, fillColor: Color? = null, translucentBackgroundColor: Color? = null, badge: String? = null, persistentBadge: Boolean = false, isLoading: Boolean = false, onClick: (() -> Unit)? = null)
    ...
    /**
     * Overrides one item's highlight colours — the rail has three, and this is how a single item
     * disagrees with the rail about any of them.
     *
     * ```
     * azTheme(activeColor = Cyan, focusColor = White, secondaryColor = Amber)
     * azRailItem(id = "record", text = "Rec")
     * azHighlight(id = "record", active = Red)        // this one goes red when it is the live screen
     * azItemState(id = "record", secondary = armed)   // and amber while merely armed
     * ```
     *
     * Every parameter is null-by-default and null means "leave it to the rail", so setting one
     * highlight never clears the other two. Unknown ids are ignored.
     *
     * @param id The id of the item to colour.
     * @param active Colour for its **active** highlight (current destination / active classifier).
...
class AzNavRailScopeImpl(private val globalIdSet: MutableSet<String> = mutableSetOf()) : AzNavRailScope {
    ...
    /**
     * Per-item highlight colours declared through [azHighlight], keyed by item id. Re-declared by
     * the DSL on every pass, like [declaredItemStates].
     */
    val declaredHighlights = mutableMapOf<String, AzItemHighlight>()
    ...
    /**
     * Per-nested-rail-host "selected child" id, keyed by the host's own item id. Consulted only for
     * hosts declared with `azNestedRail(reflectSelectionInParent = true, ...)`. Survives [reset] —
     * like [itemOverrides] and [transientCyclerOptions] — because the DSL re-runs on every
     * recomposition and would otherwise forget a tap-driven selection one frame after it happened.
     * Seeded once from a developer-supplied `selectedChildId` on first appearance (see
     * [AzNavRailScopeImpl.azNestedRail]); updated thereafter by [NestedItemWrapper]-level taps on a
     * (non-host) nested-rail child.
     */
     ...
     */
    fun applyItemStates() {
        if (declaredItemStates.isEmpty() && itemOverrides.isEmpty() && declaredHighlights.isEmpty()) return
        fun decorate(item: AzNavItem): AzNavItem {
            val declared = declaredItemStates[item.id]
            val override = itemOverrides[item.id]
            val highlight = declaredHighlights[item.id]
            ...
            if (declared == null && override == null && highlight == null) {
    ...
    /**
     * Developer-defined uniform size for every rail item button. [Dp.Unspecified] (the default)
     * keeps the built-in [AzNavRailDefaults.ButtonWidth]. Set it to make all rail items the size you
     * define (width for CIRCLE/SQUARE; the long edge for RECTANGLE/NONE).
     */
    ...
    /**
     * Colour of the **focus** highlight (pressed / last-tapped-with-no-route). [Color.Unspecified]
     * reuses [activeColor], which is the rail's historical look.
     */
    var focusColor: Color = Color.Unspecified
    /**
     * Colour of the **secondary** highlight — the developer-driven third highlight. Lit per item via
     * `azItemState(id, secondary = true)` or [secondaryClassifiers]. [Color.Unspecified] falls back
    ...
    override fun azAbout(inAppAbout: Boolean, moreFromAzEnabled: Boolean, moreFromAzJsonUrl: String, moreRailItem: Boolean, aboutRailItem: Boolean, dedupeAbout: Boolean) {
    ...
    override fun azMenuItem(id: String, text: String, route: String?, content: Any?, color: Color?, shape: AzButtonShape?, disabled: Boolean, screenTitle: String?, info: String?, classifiers: Set<String>, menuText: String?, textColor: Color?, fillColor: Color?, translucentBackgroundColor: Color?, badge: String?, persistentBadge: Boolean, isLoading: Boolean, onClick: (() -> Unit)?) {
        addItem(id = id, text = text, menuText = menuText, config = AzItemConfig(isLoading = isLoading, classifiers = classifiers, route = route, screenTitle = screenTitle, info = info, isRailItem = false, disabled = disabled, content = content, color = color, textColor = textColor, fillColor = fillColor, translucentBackgroundColor = translucentBackgroundColor, shape = shape, badge = badge, persistentBadge = persistentBadge), onClick = onClick ?: {})
    }

    override fun azHelpRailItem(id: String, text: String, content: Any?, color: Color?, shape: AzButtonShape?, menuText: String?, textColor: Color?, fillColor: Color?, translucentBackgroundColor: Color?, badge: String?, persistentBadge: Boolean, isLoading: Boolean) {
        checkId(id)
        navItems.add(
    ...
    override fun azHelpSubItem(id: String, hostId: String, text: String, content: Any?, color: Color?, shape: AzButtonShape?, menuText: String?, textColor: Color?, fillColor: Color?, translucentBackgroundColor: Color?, badge: String?, persistentBadge: Boolean, isLoading: Boolean) {
        checkId(id)
    ...
    override fun azAboutRailItem(id: String, text: String, content: Any?, color: Color?, shape: AzButtonShape?, menuText: String?, textColor: Color?, fillColor: Color?, translucentBackgroundColor: Color?, info: String?, badge: String?, persistentBadge: Boolean, isLoading: Boolean) {
        checkId(id)
        navItems.add(
            AzNavItem.About(
                id = id,
    ...
    override fun azMenuToggle(id: String, isChecked: Boolean, toggleOnText: String, toggleOffText: String, route: String?, color: Color?, shape: AzButtonShape?, disabled: Boolean, screenTitle: String?, info: String?, classifiers: Set<String>, menuToggleOnText: String?, menuToggleOffText: String?, textColor: Color?, fillColor: Color?, translucentBackgroundColor: Color?, badge: String?, persistentBadge: Boolean, isLoading: Boolean, onClick: (() -> Unit)?) {
        addToggle(id = id, isChecked = isChecked, toggleOnText = toggleOnText, toggleOffText = toggleOffText, menuToggleOnText = menuToggleOnText, menuToggleOffText = menuToggleOffText, config = AzItemConfig(isLoading = isLoading, classifiers = classifiers, route = route, disabled = disabled, screenTitle = screenTitle, info = info, isRailItem = false, isSubItem = false, color = color, textColor = textColor, fillColor = fillColor, translucentBackgroundColor = translucentBackgroundColor, shape = shape, badge = badge, persistentBadge = persistentBadge), onClick = onClick ?: {})
    }

    override fun azRailToggle(id: String, isChecked: Boolean, toggleOnText: String, toggleOffText: String, route: String?, color: Color?, shape: AzButtonShape?, disabled: Boolean, screenTitle: String?, info: String?, classifiers: Set<String>, menuToggleOnText: String?, menuToggleOffText: String?, textColor: Color?, fillColor: Color?, translucentBackgroundColor: Color?, badge: String?, persistentBadge: Boolean, isLoading: Boolean, forceHiddenMenuOpen: Boolean, onHiddenMenuDismiss: (() -> Unit)?, hiddenMenu: HiddenMenuScope.() -> Unit, onClick: (() -> Unit)?) {
        val hiddenMenuScope = HiddenMenuScopeImpl(id, hiddenMenuOnClickMap, hiddenMenuOnValueChangeMap)
        hiddenMenuScope.hiddenMenu()
        addToggle(id = id, isChecked = isChecked, toggleOnText = toggleOnText, toggleOffText = toggleOffText, menuToggleOnText = menuToggleOnText, menuToggleOffText = menuToggleOffText, config = AzItemConfig(isLoading = isLoading, classifiers = classifiers, route = route, disabled = disabled, screenTitle = screenTitle, info = info, isRailItem = true, isSubItem = false, color = color, textColor = textColor, fillColor = fillColor, translucentBackgroundColor = translucentBackgroundColor, shape = shape, badge = badge, persistentBadge = persistentBadge, hiddenMenuItems = hiddenMenuScope.items, forceHiddenMenuOpen = forceHiddenMenuOpen, onHiddenMenuDismiss = onHiddenMenuDismiss), onClick = onClick ?: {})
    }
    ...
    override fun azRailSlider(
        ...
        textColor: Color?,
        fillColor: Color?, translucentBackgroundColor: Color?,
    ...
    override fun azMenuHostItem(id: String, text: String, route: String?, content: Any?, color: Color?, shape: AzButtonShape?, disabled: Boolean, screenTitle: String?, info: String?, classifiers: Set<String>, menuText: String?, textColor: Color?, fillColor: Color?, translucentBackgroundColor: Color?, badge: String?, persistentBadge: Boolean, isLoading: Boolean, expandWhen: (() -> Boolean)?, onExpandedChange: ((Boolean) -> Unit)?, onClick: (() -> Unit)?) {
        ...
        addItem(id = id, text = text, menuText = menuText, config = AzItemConfig(isLoading = isLoading, classifiers = classifiers, route = route, screenTitle = screenTitle, info = info, isRailItem = false, disabled = disabled, isHost = true, content = content, color = color, textColor = textColor, fillColor = fillColor, translucentBackgroundColor = translucentBackgroundColor, shape = shape, badge = badge, persistentBadge = persistentBadge), onClick = onClick ?: {})
    }
    ...
    override fun azMenuSubHostItem(id: String, hostId: String, text: String, route: String?, content: Any?, color: Color?, shape: AzButtonShape?, disabled: Boolean, screenTitle: String?, info: String?, classifiers: Set<String>, menuText: String?, textColor: Color?, fillColor: Color?, translucentBackgroundColor: Color?, badge: String?, persistentBadge: Boolean, isLoading: Boolean, expandWhen: (() -> Boolean)?, onExpandedChange: ((Boolean) -> Unit)?, onClick: (() -> Unit)?) {
        ...
        if (expandWhen != null) expandWhenMap[id] = expandWhen
        if (onExpandedChange != null) onExpandedChangeMap[id] = onExpandedChange
        addItem(id = id, text = text, menuText = menuText, config = AzItemConfig(badge = badge, persistentBadge = persistentBadge, isLoading = isLoading, classifiers = classifiers, route = route, screenTitle = screenTitle, info = info, isRailItem = false, disabled = disabled, isHost = true, isSubItem = true, hostId = hostId, content = content, color = color, textColor = textColor, fillColor = fillColor, translucentBackgroundColor = translucentBackgroundColor, shape = shape), onClick = onClick ?: {})
    }
    ...
    override fun azMenuSubToggle(id: String, hostId: String, isChecked: Boolean, toggleOnText: String, toggleOffText: String, route: String?, color: Color?, shape: AzButtonShape?, disabled: Boolean, screenTitle: String?, info: String?, classifiers: Set<String>, menuToggleOnText: String?, menuToggleOffText: String?, textColor: Color?, fillColor: Color?, translucentBackgroundColor: Color?, badge: String?, persistentBadge: Boolean, isLoading: Boolean, onClick: (() -> Unit)?) {
        addToggle(id = id, isChecked = isChecked, toggleOnText = toggleOnText, toggleOffText = toggleOffText, menuToggleOnText = menuToggleOnText, menuToggleOffText = menuToggleOffText, config = AzItemConfig(badge = badge, persistentBadge = persistentBadge, isLoading = isLoading, classifiers = classifiers, hostId = hostId, route = route, disabled = disabled, screenTitle = screenTitle, info = info, isRailItem = false, isSubItem = true, color = color, textColor = textColor, fillColor = fillColor, translucentBackgroundColor = translucentBackgroundColor, shape = shape), onClick = onClick ?: {})
    }

    override fun azRailSubToggle(id: String, hostId: String, isChecked: Boolean, toggleOnText: String, toggleOffText: String, route: String?, color: Color?, shape: AzButtonShape?, disabled: Boolean, screenTitle: String?, info: String?, classifiers: Set<String>, menuToggleOnText: String?, menuToggleOffText: String?, textColor: Color?, fillColor: Color?, translucentBackgroundColor: Color?, badge: String?, persistentBadge: Boolean, isLoading: Boolean, forceHiddenMenuOpen: Boolean, onHiddenMenuDismiss: (() -> Unit)?, hiddenMenu: HiddenMenuScope.() -> Unit, onClick: (() -> Unit)?) {
        val hiddenMenuScope = HiddenMenuScopeImpl(id, hiddenMenuOnClickMap, hiddenMenuOnValueChangeMap)
        hiddenMenuScope.hiddenMenu()
        addToggle(id = id, isChecked = isChecked, toggleOnText = toggleOnText, toggleOffText = toggleOffText, menuToggleOnText = menuToggleOnText, menuToggleOffText = menuToggleOffText, config = AzItemConfig(badge = badge, persistentBadge = persistentBadge, isLoading = isLoading, classifiers = classifiers, hostId = hostId, route = route, disabled = disabled, screenTitle = screenTitle, info = info, isRailItem = true, isSubItem = true, color = color, textColor = textColor, fillColor = fillColor, translucentBackgroundColor = translucentBackgroundColor, shape = shape, hiddenMenuItems = hiddenMenuScope.items, forceHiddenMenuOpen = forceHiddenMenuOpen, onHiddenMenuDismiss = onHiddenMenuDismiss), onClick = onClick ?: {})
    }
    ...
    override fun azRailRelocItem(id: String, hostId: String, text: String, route: String?, content: Any?, color: Color?, shape: AzButtonShape?, disabled: Boolean, screenTitle: String?, info: String?, classifiers: Set<String>, menuText: String?, textColor: Color?, fillColor: Color?, translucentBackgroundColor: Color?, badge: String?, persistentBadge: Boolean, isLoading: Boolean, onFocus: (() -> Unit)?, onRelocate: ((Int, Int, List<String>) -> Unit)?, nestedRailAlignment: AzNestedRailAlignment, keepNestedRailOpen: Boolean, nestedContent: (AzNavRailScope.() -> Unit)?, forceHiddenMenuOpen: Boolean, onHiddenMenuDismiss: (() -> Unit)?, hiddenMenu: HiddenMenuScope.() -> Unit, onClick: (() -> Unit)?) {
        checkId(id)
        val hiddenMenuScope = HiddenMenuScopeImpl(id, hiddenMenuOnClickMap, hiddenMenuOnValueChangeMap)
        hiddenMenuScope.hiddenMenu()
        ...
        navItems.add(
            AzNavItem(badge = badge, persistentBadge = persistentBadge, isLoading = isLoading, 
                ...
                hiddenMenuItems = hiddenMenuScope.items, forceHiddenMenuOpen = forceHiddenMenuOpen, onHiddenMenuDismiss = onHiddenMenuDismiss, classifiers = classifiers, content = content, color = color, textColor = textColor, fillColor = fillColor, translucentBackgroundColor = translucentBackgroundColor, shape = shape,
    ...
    private fun addCycler(id: String, options: List<String>, menuOptions: List<String>? = null, selectedOption: String, disabledOptions: List<String>? = null, config: AzItemConfig, onClick: () -> Unit) {
        ...
        navItems.add(
            AzNavItem(
                id = id, text = selectedOption, route = config.route, screenTitle = finalScreenTitle, isRailItem = config.isRailItem,
                ...
                fillColor = config.fillColor, translucentBackgroundColor = config.translucentBackgroundColor, shape = config.shape, badge = config.badge,
                persistentBadge = config.persistentBadge, isLoading = config.isLoading,
                hiddenMenuItems = config.hiddenMenuItems, forceHiddenMenuOpen = config.forceHiddenMenuOpen, onHiddenMenuDismiss = config.onHiddenMenuDismiss
            )
        )
    }
    ...
    private fun addToggle(id: String, isChecked: Boolean, toggleOnText: String, toggleOffText: String, menuToggleOnText: String? = null, menuToggleOffText: String? = null, config: AzItemConfig, onClick: () -> Unit) {
        ...
        navItems.add(
            AzNavItem(
                id = id, text = text, route = config.route, screenTitle = finalScreenTitle, isRailItem = config.isRailItem,
                ...
                textColor = config.textColor, fillColor = config.fillColor, translucentBackgroundColor = config.translucentBackgroundColor, shape = config.shape, badge = config.badge,
                persistentBadge = config.persistentBadge, isLoading = config.isLoading,
                hiddenMenuItems = config.hiddenMenuItems, forceHiddenMenuOpen = config.forceHiddenMenuOpen, onHiddenMenuDismiss = config.onHiddenMenuDismiss
            )
        )
    ...
    private fun addItem(id: String, text: String, menuText: String? = null, config: AzItemConfig, onClick: () -> Unit) {
        ...
        navItems.add(
            AzNavItem(
                ...
                fillColor = config.fillColor, translucentBackgroundColor = config.translucentBackgroundColor,
                shape = config.shape,
                ...
                forceHiddenMenuOpen = config.forceHiddenMenuOpen,
                onHiddenMenuDismiss = config.onHiddenMenuDismiss
            )
        )
    }
}
