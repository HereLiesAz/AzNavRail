...
// annotation was removed after the UX Analyzer flagged this as unreachable — same reasoning
// as StandaloneWidgetsRoute (see that file).
const val LegacyRoute = "legacy"
