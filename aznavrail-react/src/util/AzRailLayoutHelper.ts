  ...
  static calculateLayout(
    ...
    if (usePhysicalDocking) {
      if (dockingSide === AzDockingSide.LEFT) {
        switch (rotation) {
          case 0:
            visualSide = AzVisualSide.LEFT;
            break;
          case 90:
            visualSide = AzVisualSide.BOTTOM;
            break;
          case 180:
            visualSide = AzVisualSide.RIGHT;
            break;
          case 270:
            visualSide = AzVisualSide.TOP;
            break;
          default:
            visualSide = AzVisualSide.LEFT;
        }
    ...
    const orientation =
      visualSide === AzVisualSide.TOP || visualSide === AzVisualSide.BOTTOM
    ...
    switch (visualSide) {
      case AzVisualSide.LEFT:
        alignment = 'TopStart';
        break;
      case AzVisualSide.RIGHT:
        alignment = 'TopEnd';
        break;
      case AzVisualSide.TOP:
        alignment = 'TopStart';
        break;
      case AzVisualSide.BOTTOM:
