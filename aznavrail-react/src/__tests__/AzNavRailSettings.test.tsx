...
// render commit doesn't loop. If you see "Maximum update depth exceeded" here again,
...
describe('AzNavRail rendering with AzNavRailSettings flags', () => {
  ...
  const mount = (jsx: React.ReactElement) => render(jsx);

  it('mounts a bare AzNavRail with a single AzRailItem (smoke: AzRailItem registers without error)', async () => {
  ...
  it('mounts with AzRailItem + AzMenuItem + AzHelpRailItem children (smoke: mixed DSL items coexist)', async () => {
  ...
  it('respects noMenu=true (smoke: rail still mounts when menu expansion is permanently disabled)', async () => {
  ...
  it('respects isLoading=true (renders the loading overlay at root level)', async () => {
  ...
  it('respects defaultShape=SQUARE (smoke: alt button shape mounts without error)', async () => {
  ...
  it('respects dockingSide=RIGHT (rail mounts on right edge)', async () => {
  ...
  it('respects headerIconShape=SQUARE (smoke: header icon shape variant mounts)', async () => {
  ...
  it('respects showFooter=false (rail mounts without the footer block)', async () => {
  ...
  it('respects displayAppNameInHeader=false (smoke: app-name omitted from header)', async () => {
  ...
  it('respects expandedRailWidth and collapsedRailWidth overrides (smoke: numeric width props pass through)', async () => {
  ...
  it('respects activeColor (smoke: custom accent colour string mounts)', async () => {
  ...
  it('respects enableRailDragging=true (smoke: drag-to-float flag mounts)', async () => {
  ...
  it('respects helpEnabled=true with helpList map (smoke: help-overlay registry mounts)', async () => {
  ...
  it('respects packRailButtons=true (smoke: tight-pack layout mounts)', async () => {
