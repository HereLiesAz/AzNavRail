...
interface AzNestedRailPopupProps {
    ...
    /** Which side the parent rail is docked to, used to position the popup on the correct side. */
    dockingSide: 'LEFT' | 'RIGHT';
}

/** Native implementation: Modal panel that floats next to a nested-rail host item and displays its sub-items. */
