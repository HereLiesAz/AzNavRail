...
const AzTextBox = ({
  ...
  return /*#__PURE__*/_react.default.createElement("div", {
  ...
  }, leadingIcon), /*#__PURE__*/_react.default.createElement(InputComponent, {
  ...
  }), currentValue && enabled && !readOnly && /*#__PURE__*/_react.default.createElement("div", {
    className: "az-textbox-icon action",
    onClick: secret ? () => setIsRevealed(!isRevealed) : handleClear
  }, secret ? isRevealed ? '👁️' : '👁️‍🗨️' : '✕'), trailingIcon && /*#__PURE__*/_react.default.createElement("div", {
    className: "az-textbox-icon trailing"
  }, trailingIcon), onSubmit && /*#__PURE__*/_react.default.createElement("button", {
    ...
    disabled: !enabled
  }, "Submit")), showSuggestions && filteredSuggestions.length > 0 && /*#__PURE__*/_react.default.createElement("div", {
    className: "az-textbox-suggestions",
    style: {
      borderColor: color
    }
  }, filteredSuggestions.map((suggestion, index) => /*#__PURE__*/_react.default.createElement("div", {
    key: index,
    className: "az-textbox-suggestion-item",
    onClick: () => handleSuggestionClick(suggestion)
  }, suggestion))));
};
var _default = exports.default = AzTextBox;
