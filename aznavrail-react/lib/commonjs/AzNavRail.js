...
const AzNavRailInner = props => {
  ...
  const railItemsCount = (0, _react.useMemo)(() => {
  ...
  return /*#__PURE__*/_react.default.createElement(_AzNavRailScope.AzNavRailContext.Provider, {
  ...
  }, isFloating && !showFloatingButtons ? null : effectiveRailItems.map((item, index) => renderRailItem(item, index)))), items.filter(i => i.isNestedRail).map(item => /*#__PURE__*/_react.default.createElement(_AzNestedRailPopup.AzNestedRailPopup, {
    key: `nested-${item.id}`,
    ...
    renderItem: (subItem, idx) => /*#__PURE__*/_react.default.createElement(_reactNative.View, {
      key: `wrap-${subItem.id}`,
  ...
  }, children), isLoading && /*#__PURE__*/_react.default.createElement(_reactNative.View, {
