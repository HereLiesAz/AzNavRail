...
import { AzButtonShape, AzDockingSide, AzHeaderIconShape, AzNestedRailAlignment } from './types';
...
const AzNavRailInner = props => {
  ...
  const renderRailItem = (item, _index) => {
  ...
  const renderFooter = () => {
    ...
    }, `Undock`)), /*#__PURE__*/React.createElement(TouchableOpacity, {
      onPress: handleAbout,
      style: {
        paddingVertical: 4
      }
  ...
  return /*#__PURE__*/React.createElement(AzNavRailContext.Provider, {
    ...
    numberOfLines: 1
  }, "App Name")), isExpanded && !noMenu ? /*#__PURE__*/React.createElement(ScrollView, {
  ...
  }, isFloating && !showFloatingButtons ? null : effectiveRailItems.map((item, index) => renderRailItem(item, index)))), items.filter(i => i.isNestedRail).map(item => /*#__PURE__*/React.createElement(AzNestedRailPopup, {
    key: `nested-${item.id}`,
    ...
    renderItem: (subItem, idx) => /*#__PURE__*/React.createElement(View, {
      key: `wrap-${subItem.id}`,
  ...
  }, children), isLoading && /*#__PURE__*/React.createElement(View, {
    style: styles.loaderOverlay
  }, /*#__PURE__*/React.createElement(AzLoad, null)), infoScreen && /*#__PURE__*/React.createElement(HelpOverlay, {
    items: items,
    helpList: config.helpList || {},
...
const TutorialOverlayWrapper = ({
  ...
  return /*#__PURE__*/React.createElement(AzTutorialOverlay, {
    tutorialId: activeId,
