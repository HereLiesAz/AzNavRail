...
const AzNavRail = ({
  ...
  const renderMenuItem = (item, depth = 0) => {
    ...
    if (item.isDivider) {
      return /*#__PURE__*/React.createElement(AzDivider, {
        key: item.id
      });
    }
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("div", {
    ...
    className: "menu"
  }, menuItems.map(item => renderMenuItem(item))) : /*#__PURE__*/React.createElement("div", {
    ...
    if (item.isDivider) return /*#__PURE__*/React.createElement(AzDivider, {
      key: item.id
    });
    const finalItem = item.isCycler ? {
      ...item,
    ...
    if (item.isRelocItem) {
      ...
      }, /*#__PURE__*/React.createElement(AzNavRailButton, {
        item: {
          ...finalItem,
          isActive
      ...
      }), hiddenMenuOpenId === item.id && item.hiddenMenu && /*#__PURE__*/React.createElement("div", {
  ...
  }, appName), !!appRepositoryUrl && /*#__PURE__*/React.createElement("div", {
    className: "az-menu-item-text",
    style: {
      padding: '4px 0',
      cursor: 'pointer'
  ...
  }, "@HereLiesAz")), showFooterPopup && effectiveNoMenu && /*#__PURE__*/React.createElement("div", {
    style: {
      position: 'fixed',
      bottom: '20px',
      left: '50%',
  ...
  }, /*#__PURE__*/React.createElement("div", null, appName), /*#__PURE__*/React.createElement("button", {
    onClick: () => setShowFooterPopup(false),
    style: {
      marginTop: '8px'
    }
  }, "Close"))), infoScreen && /*#__PURE__*/React.createElement("div", {
  ...
  })), showAbout && !!appRepositoryUrl && /*#__PURE__*/React.createElement(AboutOverlay, {
    ...
    renderItem: (sub, idx) => /*#__PURE__*/React.createElement(AzNavRailButton, {
      key: sub.id,
      item: sub,
      onCyclerClick: () => handleCyclerClick(sub),
      infoScreen: infoScreen,
